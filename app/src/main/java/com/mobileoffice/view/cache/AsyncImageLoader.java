package com.mobileoffice.view.cache;
...
import com.mobileoffice.view.cache.disk.LruDiskCache;
import com.mobileoffice.view.cache.memory.LruMemoryCache;
...
public class AsyncImageLoader
{
	...
	public File getDiskCacheDir(Context context, String uniqueName)
	{
		...
		//Toast.makeText(context,"cachePath:"+cachePath,Toast.LENGTH_LONG).show();
