...
import com.mobileoffice.controller.cloud_monitor.PostRoleAdapter;
import com.mobileoffice.json.PostRoleJson;

import java.util.List;

public class PostRolePopup extends PopupWindow implements PostRoleAdapter.OnRecyclerViewItemClickListener{
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;
    private PostRoleAdapter mPostRoleAdapter;
    private RecyclerView rv_post_role;
    private List<PostRoleJson.PostRole> mPostRoles;
    private String mPostRole;


    public PostRolePopup(final Activity context, List<PostRoleJson.PostRole> postRoles,String postRole) {
        mContext = context;
        mPostRole = postRole;
    ...
    private void recycler(List<PostRoleJson.PostRole> postRoles,String postRole) {
        mGridLayoutManager = new GridLayoutManager(mContext, 2);
        rv_post_role.setLayoutManager(mGridLayoutManager);
        mPostRoleAdapter = new PostRoleAdapter(postRoles, mContext,postRole);
