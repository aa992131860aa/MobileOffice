...
import com.mobileoffice.entity.OpoInfoContact;

import java.util.List;

public class OpoInfoContactPopup extends PopupWindow {

    private RecyclerView rv_popup_single;
    private LinearLayoutManager mLinearLayoutManager;

    private List<OpoInfoContact> mData;
    private Activity mContext;
   private TransferAdapter mAdapter;

    public OpoInfoContactPopup(final Activity context, List<OpoInfoContact> dataList) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflater.inflate(R.layout.contact_popup_single, null);
        mContext = context;
        mData = dataList;
...
//            this.showAsDropDown(parent, -20, 5);
    ...
    class TransferAdapter extends RecyclerView.Adapter<TransferAdapter.MyViewHolder> {
        ...
        public TransferAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.contact_adapter_pop, parent,false);
        ...
        public void onBindViewHolder(TransferAdapter.MyViewHolder holder, final int position) {
                holder.id_popup_tv.setText(mData.get(position).getContactName());
