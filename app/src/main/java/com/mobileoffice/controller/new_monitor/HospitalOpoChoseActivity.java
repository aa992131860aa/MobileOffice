...
import com.mobileoffice.json.OpoProvinceJson;
...
public class HospitalOpoChoseActivity extends BaseActivity implements AMapLocationListener, HospitalParentAdapter.HospitalParentListener, HospitalOpoChildAdapter.HospitalChildListener {
    ...
    private List<Opo> mChilds;
    private Context mContext;
    private HospitalParentAdapter mHospitalParentAdapter;
    private HospitalOpoChildAdapter mHospitalChildAdapter;
    ...
    protected void initVariable() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(HospitalOpoChoseActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, CAMERA_CODE_PERMISSION);
        } else {
            location();
        }
        ...
        mHospitalChildAdapter = new HospitalOpoChildAdapter(this, mChilds);
    ...
    private void loadParentData() {
        ...
        params.addQueryStringParameter("action", "province");
    ...
    private void loadChildData(String province) {
        RequestParams params = new RequestParams(URL.OPO);
        params.addQueryStringParameter("action", "opoInfo");
        params.addQueryStringParameter("province", province);
        x.http().get(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                Gson gson = new Gson();
                OpoProvinceJson proviceJson = gson.fromJson(result, OpoProvinceJson.class);
                if (proviceJson != null && proviceJson.getResult() == CONSTS.SEND_OK) {
                    mChilds = proviceJson.getObj() == null ? new ArrayList<Opo>() : proviceJson.getObj();
        ...
        switch (requestCode) {
            case CAMERA_CODE_PERMISSION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtil.showToast("没有开启定位权限", HospitalOpoChoseActivity.this);
    ...
    @Override
    public void OnHospitalParentClick(View thisView, Opo opo) {
//        CONSTS.HOSPITAL_NAME_TRANSFER = opo.getName();
//        CONSTS.HOSPITAL_NAME_TRANSFER_NAME = opo.getContactName();
//        CONSTS.HOSPITAL_NAME_TRANSFER_PHONE = opo.getContactPhone();
//        SharePreUtils.putString("opoName", opo.getName(), this);
//        SharePreUtils.putString("contactName", opo.getContactName(), this);
//        SharePreUtils.putString("contactPhone", opo.getContactPhone(), this);
//        SharePreUtils.putString("contactUrl", "", this);
        Intent intent = new Intent();

        intent.putExtra("opo", opo);

        setResult(ContactInfoFragment.RESULT_CODE,intent);
