...
public abstract class BaseAdapter1<T> extends android.widget.BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position==0){
            ...
            this.bindView(view, position,null);
        }else {
           // if (convertView != null) {
           //     view = convertView;
          //  } else {
                view = this.newView(this.mContext, position, parent);
            this.bindView(view, position, this.getItem(position-1));
          //  }
        }
