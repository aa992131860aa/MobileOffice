...
public class ContactPersonAddAdapter extends RecyclerView.Adapter<ContactPersonAddAdapter.MyViewHolder> {
    ...
    public ContactPersonAddAdapter(List<ContactSearchJson.ObjBean> objBeens, Context context) {
        mObjBeans = objBeens;
        mContext = context;
    }
