...
public class DemoUtil {
    ...
    * 下面的消息类型均是按发送数据包的类型来划分，ACK对应包的应答*/
	...
	public static void setTitleOfApp(Activity activity, final String status, boolean isConnected) {
		...
		if(isConnected){
			actionBar.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.cloud_1index_id));
		}else{
			actionBar.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.cloud_1index_info));
		}
	}
