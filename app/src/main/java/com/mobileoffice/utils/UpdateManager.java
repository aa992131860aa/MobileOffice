...
import com.mobileoffice.controller.SkipActivity;
import com.mobileoffice.service.UpadteService;
...
public class UpdateManager {
    ...
    public void checkUpdateInfo() {
       String isUpdate =  SharePreUtils.getString("isUpdate","",mContext);
       // ToastUtil.showToast("isUpdate:"+isUpdate,mContext);
...
//        downloadDialog.show();
        Intent intent = new Intent(mContext, UpadteService.class);
    ...
    protected void installApk() {
        ...
        //更改引导页是否显示
        SharePreUtils.putBoolean("first",false,mContext);
        SharePreUtils.getBoolean("login",true,mContext);
